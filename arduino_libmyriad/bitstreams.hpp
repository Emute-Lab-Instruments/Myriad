...
uint32_t FAST_MEM timing_swapbuffer_##name##_A[24] __attribute__((aligned(16))) {0,0}; \
uint32_t FAST_MEM timing_swapbuffer_##name##_B[24] __attribute__((aligned(16))) {0,0}; \
