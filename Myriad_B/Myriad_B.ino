...
// SerialPIO uartIn(SerialPIO::NOPIN, 10, 64);
...
//   dsp_clock_forever(pio, 1, offset, pdmFreq);
//   // irq_set_exclusive_handler(PIO0_IRQ_0, irq_handler_osc_coreB0);
...
//  __wfi();
  // if(uartIn.available()) {
    // int v = uartIn.read();
    // int res = uartIn.readBytesUntil(SLIP::END, slipBuffer,64);
  //   // wavelen0 = v * 100;
  //   // Serial.print(res);
  //   // Serial.print("\t");
  //   // Serial.println(slipBuffer[0]);
  //   Serial.println(v);
  // }
  readUart();
  // __wfi();
...
//   irq_set_exclusive_handler(PIO1_IRQ_0, irq_handler_osc_coreB1);
